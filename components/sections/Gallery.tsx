    ...
    <div className="w-full flex justify-center">
      <div className="max-w-[1500px] w-full px-5 pt-36 pb-10">
        <div className="flex w-full flex-col gap-3 items-center justify-center">
          ...
          <Link href="" className="text-[#005e06] font-bold text-[16px]">
            See more
          </Link>
        </div>
        <div className="grid grid-cols-1  md:grid-cols-5 gap-5 mt-6">
          <div className="bg-slate-300 rounded-4xl h-[300px] md:col-span-3"></div>
          <div className="bg-slate-300 rounded-4xl h-[300px] md:col-span-2"></div>
          <div className="bg-slate-300 rounded-4xl h-[300px] md:col-span-2"></div>
          <div className="bg-slate-300 rounded-4xl h-[300px] md:col-span-3"></div>
        </div>
      </div>
